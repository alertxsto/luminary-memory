...
- The default SQLite backend stores embeddings and content in plaintext on disk. Protect the file with filesystem permissions.
- The pgvector backend requires a PostgreSQL instance — secure it with a strong password and network access control.
- Never commit a live database file or credentials to version control.
