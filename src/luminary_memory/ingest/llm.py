                ...
                [
                    {
                        ...
                        "content": (
                            ...
                            "Be permissive: a turn about ongoing work often contains durable facts "
                            "(decisions, conventions, environment setup) even if the topic is a task. "
                            "Extract the durable fact and save it.\n"
                            "Do NOT save: pure chit-chat, greetings, trivial acknowledgements, or "
                            "pure work-log lines (e.g. 'done', 'pushed', 'fixed it') that carry no "
                            "durable fact. If a turn mixes work-log and a real fact, SAVE the fact "
                            "and summarize only the fact.\n"
                            "Return STRICT JSON with exactly these keys:\n"
                            "- worth_saving (boolean): true when a durable fact exists (even inside "
                            "a work conversation); false only for pure chit-chat or pure work-log "
                            "with no fact.\n"
